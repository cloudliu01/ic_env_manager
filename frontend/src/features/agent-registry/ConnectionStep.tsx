...
export function ConnectionStep({ values, errors, onChange, onBlur, locked, targetLocked }: { values: ConnectionValues; errors: Partial<Record<keyof ConnectionValues, string>>; onChange: (field: keyof ConnectionValues, value: string) => void; onBlur: (field: keyof ConnectionValues) => void; locked?: boolean; targetLocked?: boolean }) {
