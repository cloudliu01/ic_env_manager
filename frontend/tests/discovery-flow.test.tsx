...
describe('Discovery flow', () => {
  beforeEach(() => {
    ...
    apiRequest.mockImplementation(async (path: string, init?: RequestInit) => {
      ...
      if (path === '/api/v2/discovery/jobs/scan-opaque/results') return { results: [{ result_id: 'result-opaque', candidate_url: 'http://10.0.0.4:8765', ip: '10.0.0.4', port: 8765, transport_profile_id: 'eda-http', status: 'ready', enrollment_status: 'available' }] };
